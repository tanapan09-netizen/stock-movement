...
export const securityConfig = {
    ...
    rateLimit: {
        ...
        endpoints: {
            ...
            '/api/auth/session': { max: 500, windowMs: 60 * 1000 },
            '/api/auth/csrf': { max: 500, windowMs: 60 * 1000 },

            // Strict limits for login
            '/api/auth/signin': { max: 10, windowMs: 60 * 1000 },
            '/api/auth/callback/.*': { max: 20, windowMs: 60 * 1000 },

            // General fallbacks
            '/api/auth/.*': { max: 100, windowMs: 60 * 1000 },
            '/api/security/.*': { max: 20, windowMs: 60 * 1000 },
