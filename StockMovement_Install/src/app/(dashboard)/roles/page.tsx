            ...
            <div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {users.map((user) => (
                        ...
                        ${user.role === 'admin' ? 'bg-purple-600' : user.role === 'manager' ? 'bg-blue-500' : user.role === 'technician' ? 'bg-orange-500' : user.role === 'operation' ? 'bg-teal-500' : 'bg-green-500'}
                     `}>
                            ...
                            {isAdmin && (
                                <div className="flex flex-col space-y-2">
                                    <Link href={`/roles/${user.p_id}/edit`} className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-full transition">
