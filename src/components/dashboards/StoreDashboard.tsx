...
import { Package, AlertTriangle, Activity, ArrowUpRight, ArrowDownRight, TrendingUp, Clock, DollarSign, BarChart3, ArrowRight } from 'lucide-react';
        ...
        <div className="max-w-[1600px] mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm font-medium">
                        ภาพรวมสต็อกสำหรับคลังสินค้า (Store / Operations)
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
                ...
                <StatCard
                    ...
                    subtitle={outOfStock > 0 ? `หมดชั่วคราว ${outOfStock} รายการ` : "ควรสั่งซื้อเพิ่ม"}
                />
            </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-700">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <Link href="/stock/adjust" className="group p-4 rounded-xl border border-gray-100 hover:border-blue-200 bg-gray-50 hover:bg-blue-50 transition-all text-center">
                                ...
                                <div className="font-semibold text-gray-700 group-hover:text-blue-700">ปรับ/เบิกสต็อก</div>
                            </Link>
                            ...
                            <Link href="/purchase-orders" className="group p-4 rounded-xl border border-gray-100 hover:border-purple-200 bg-gray-50 hover:bg-purple-50 transition-all text-center">
                                ...
                                <div className="font-semibold text-gray-700 group-hover:text-purple-700">รับสินค้า (PO)</div>
                            </Link>
                            <Link href="/borrow" className="group p-4 rounded-xl border border-gray-100 hover:border-orange-200 bg-gray-50 hover:bg-orange-50 transition-all text-center">
                                ...
                                <div className="font-semibold text-gray-700 group-hover:text-orange-700">ยืม-คืน อุปกรณ์</div>
                            </Link>
                        </div>
                    </div>
                </div>
