...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header h2 { font-size: 18px; color: #374151; font-weight: normal; }
    .header .date { font-size: 12px; color: #6b7280; margin-top: 10px; }
    .info-grid {
      display: grid;
    ...
    .summary h3 { color: #1e40af; margin-bottom: 12px; font-size: 14px; }
    .summary-grid {
      display: grid;
...
<body>
  <div class="report-container">
    ...
    <div class="info-grid">
      ...
      <div class="info-item">
        <span class="info-label">ค่าเสื่อมต่อปี:</span>
