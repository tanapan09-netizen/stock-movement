...
export const ROLE_OPTIONS = [
    ...
    { value: 'leader_employee', label: 'Leader Employee (หัวหน้าพนักงาน)' },
    { value: 'employee', label: 'Employee (พนักงาน)' },
    { value: 'leader_technician', label: 'Leader Technician (หัวหน้าช่าง)' },
    ...
    { value: 'leader_operation', label: 'Leader Operation (หัวหน้าปฏิบัติการ)' },
    { value: 'operation', label: 'Operation (ปฏิบัติการ)' },
