export const PROCUREMENT_STATUS_META = {
    ...
    returned: {
        label: 'ตีกลับแก้ไข',
        badgeClass: 'border-orange-200 bg-orange-50 text-orange-700 dark:border-orange-800 dark:bg-orange-900/40 dark:text-orange-300',
        order: 1,
    },
    approved: {
        label: 'อนุมัติแล้ว',
...
export const PURCHASE_REQUEST_STATUS_FILTER_OPTIONS = [
    ...
    { value: 'returned', label: PROCUREMENT_STATUS_META.returned.label },
