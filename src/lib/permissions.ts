export const PERMISSIONS = {
    ...
    APPROVALS: 'approvals',
    PURCHASING_APPROVALS: 'purchasing_approvals',
...
const ROUTE_REQUIRED_PERMISSIONS: Record<DashboardRoute, RouteRequirement> = {
    ...
    '/manager-dashboard': PERMISSIONS.DASHBOARD,
    ...
    '/reports/movement': PERMISSIONS.ADMIN_REPORTS,
    '/reports/maintenance': PERMISSIONS.ADMIN_REPORTS,
    '/reports/warehouse-stock': PERMISSIONS.ADMIN_REPORTS,
    ...
    '/settings/asset-policy': PERMISSIONS.ADMIN_SETTINGS,
    '/settings/storage-cleanup': PERMISSIONS.ADMIN_SETTINGS,
    ...
    '/store-dashboard': PERMISSIONS.DASHBOARD,
...
export const DEFAULT_PERMISSIONS: Record<string, RolePermissions> = {
    ...
    leader_technician: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.GENERAL_REQUEST]: true,
        [PERMISSIONS.MAINTENANCE]: true,
        [PERMISSIONS.MAINTENANCE_DASHBOARD]: true,
    ...
    leader_operation: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.PRODUCTS]: true,
        [PERMISSIONS.MOVEMENTS]: true,
        [PERMISSIONS.STOCK_ADJUST]: true,
    ...
    leader_employee: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.BORROW]: true,
        [PERMISSIONS.GENERAL_REQUEST]: true,
        [PERMISSIONS.MAINTENANCE]: true,
    ...
    leader_general: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.PRODUCTS]: true,
        [PERMISSIONS.MOVEMENTS]: true,
        [PERMISSIONS.BORROW]: true,
    ...
    leader_maid: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.GENERAL_REQUEST]: true,
        [PERMISSIONS.MAINTENANCE]: true,
        [PERMISSIONS.BORROW]: true,
    ...
    leader_driver: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.GENERAL_REQUEST]: true,
        [PERMISSIONS.MAINTENANCE]: true,
        [PERMISSIONS.BORROW]: true,
    ...
    leader_accounting: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.PETTY_CASH]: true,
        [PERMISSIONS.MAINTENANCE_REQUESTS]: true,
        [PERMISSIONS.PO_VIEW]: true,
    ...
    leader_purchasing: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.PRODUCTS]: true,
        [PERMISSIONS.ADMIN_SUPPLIERS]: true,
        [PERMISSIONS.MAINTENANCE_REQUESTS]: true,
    ...
    leader_store: buildRolePermissions({
        [PERMISSIONS.DASHBOARD]: true,
        [PERMISSIONS.PRODUCTS]: true,
        [PERMISSIONS.MOVEMENTS]: true,
        [PERMISSIONS.STOCK_ADJUST]: true,
